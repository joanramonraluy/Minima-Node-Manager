...
async function main() {
    ...
    function showBuildPipeline() {
        ...
        zipBtn.on('press', function() {
            ...
            var zipCmd = 'cd ' + JSON.stringify(workspace) + ' && zip -r /tmp/minidapp.mds . -x "MinimaAds.mds.zip" "latest-deploy.mds" ".git" ".git/*" "refs" "refs/*" "docs" "docs/*" "logs" "logs/*" ".claude" ".claude/*" ".playwright-mcp" ".playwright-mcp/*" ".codex" "CLAUDE.md" "AGENTS.md" "MinimaAds.md" "PROJECT_INDEX.md" "README.md"';
